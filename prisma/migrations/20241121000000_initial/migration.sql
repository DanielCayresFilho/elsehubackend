...
-- CreateEnum
CREATE TYPE "InstanceProvider" AS ENUM ('META', 'EVOLUTION');

-- CreateEnum
CREATE TYPE "ConversationStatus" AS ENUM ('PENDING', 'OPEN', 'CLOSED', 'EXPIRED');

-- CreateEnum
CREATE TYPE "MessageDirection" AS ENUM ('INBOUND', 'OUTBOUND');

-- CreateEnum
CREATE TYPE "CampaignStatus" AS ENUM ('PENDING', 'SCHEDULED', 'RUNNING', 'PAUSED', 'COMPLETED', 'FAILED');
